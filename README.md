...
I develop a lightweight Micrograd-based neural-network framework from the ground up to figure out the core mathematics of deep learning. The implementation constructs scalar computational graphs, performs forward propagation, computes loss, applies reverse-mode backpropagation, accumulates gradients, updates parameters through simple optimization, and model save and load. 
